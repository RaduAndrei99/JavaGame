...
public class RoomModel4 extends Room {
    ...
    public RoomModel4(RefLinks refs, boolean createDoors){
        ...
        try {
            ...
            while(read_x != -1 || read_y != -1){
                if(rand.nextInt(1) + 1 == 1)
                    ...
                    enemies.add(EnemiesFactory.getEnemy(refs,3,read_x,read_y));
            ...
            ErrorScreenPrinter.addErrorMessage("There is no file for room_model_4. - " + e.getMessage());
            e.printStackTrace();
        }catch (NoSuchElementException e){
            ErrorScreenPrinter.addErrorMessage("The file room_model_4 is corrupt! - " + e.getMessage());
        }
    }
