...
public class RoomModel3 extends Room {
    ...
    public RoomModel3(RefLinks refs, boolean createDoors){
       super(refs, createDoors);
        ...
        try {
            ...
            ErrorScreenPrinter.addErrorMessage("There is no file for room_model_3. - " + e.getMessage());
            e.printStackTrace();
        }catch (NoSuchElementException e){
            ErrorScreenPrinter.addErrorMessage("The file room_model_3 is corrupt! - " + e.getMessage());
        }
    }
