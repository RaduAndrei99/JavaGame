...
public class RoomModel7 extends Room {

    public RoomModel7(RefLinks refs, boolean createDoors) {
        ...
        try {
            File myObj = new File("res/Rooms/room_7.txt");
            ...
            ErrorScreenPrinter.addErrorMessage("There is no file for room_model_7. - " + e.getMessage());
            e.printStackTrace();
        }catch (NoSuchElementException e){
            ErrorScreenPrinter.addErrorMessage("The file room_model_7 is corrupt! - " + e.getMessage());
        }
...
/*
    ...
    public void createNextLevelDoor(){
        nextLevelDoor  = new NextLevelDoor(refs,27*48, 3*48 );
    }
}
